...
Changes:
  - /agent-logs router wired in for live frontend Agent Analytics strip hello
"""
...
try:
    app.mount(
        "/static/drawings", StaticFiles(directory="uploads/drawings"), name="drawings"
    )
except RuntimeError:
    pass
...
app.include_router(
    agent_logs_router, prefix="/agent-logs", tags=["Agent Logs"]
)  # ← new
